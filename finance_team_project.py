...
RESPONSE_PROMPT = "Evaluate Google latest product impact from both technical and financial perspectives."

tech_stocks_team.print_response(RESPONSE_PROMPT, stream=True)